			...
			<div class="container">
				<div class="signup-content">
					<div class="signup-form">
						<h2 class="form-title">AIR CONDITIONER</h2>
					
						<form method="post" action="ac" class="register-form"
							id="register-form">
							<div class="form-group">
								<label for="user"><i
									class="zmdi zmdi-account material-icons-name"></i></label> <input
									type="text" name="user" id="user" placeholder="Your User Name" required="required" />
							</div>
							<div class="form-group">
								<label for="name"><i
									class="zmdi zmdi-account material-icons-name"></i></label> <input
							...
							<div class="form-group">
								<label for="Address"><i class="zmdi zmdi-collection-bookmark"></i></label> <input
									type="Address" name="Address" id="Address" placeholder="Your Address" required="required" />
							</div>
							<div class="form-group">
					...
					<div class="signup-image">
						<figure>
							<img src="assets/img/portfolio/ac.jfif" alt="sing up image">
						</figure>
